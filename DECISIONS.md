...
⚠️ **New gap this opened:** **Hornsby is not in `service-areas.json`** and is not in any Tier-1 or
hub region in `docs/BATHROOM_SITE_STRUCTURE.md` — yet it is now two of the five projects with
photography. **Castle Hill and Randwick are both Tier-1**, so their photos are ready-made local
proof when those pages get built. Hornsby needs a decision: add it to the structure, or leave it as
