...
| **D-37** | **The Dawood family has three principals, not two: Omar and Adam (Projects Managers) and Farah Dawood (Architectural Designer).** | **CONFIRMED** | Owner (Omar) confirmed 2026-08-17, resolving Flag 2 in `docs/IMAGE_INVENTORY.md` — Farah appeared in a "Meet Our Family Team" marketing graphic not previously reflected in any project doc. Update any future "Omar and Adam" copy to include Farah where the team is described. |
