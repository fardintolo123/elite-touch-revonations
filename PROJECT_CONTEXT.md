...
| K14 | ⚠️ **NEW 2026-08-25 — a second, richer photo batch has been supplied** (`Projects Before & After (1)/`, outside the repo): 9 projects, 38 photos, each with a written Project Info doc giving budget, timeframe, scope of works and outcome. Full triage in [plans/2026-08-25-new-project-photos-intake.md](../plans/2026-08-25-new-project-photos-intake.md). **Blocked on:** (1) consent for this specific batch has not been confirmed (D-39 covers only the original 33/34), (2) two folders' names don't match their own doc's stated location (Mosman↔Drummoyne, North Ryde↔North Sydney), (3) two projects are standalone laundry renovations, which D-01/D-45 don't currently permit as a published case study, (4) Hunters Hill and The Rocks in this batch closely match two existing text-only case studies and may be the same jobs. Balmain, Gladesville and Little Bay have no flags beyond consent | Owner |
