...
| Sitemap `lastmod` = build time; add `updated` field | tech M-2 | ✅ **#23** |
| `ImageObject` + `og:type:article` on gallery pages | tech L-5/L-6, schema S-2 | ✅ **#24** |
...
| **#41** visible freshness + image sitemap + cadence | P2 | #23 |
