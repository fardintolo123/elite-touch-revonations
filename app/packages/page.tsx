...
export const metadata: Metadata = buildMetadata({
  ...
  // Dedicated share image (issue #20 follow-up) — generated by
  // scripts/generate-og-image.mjs, headlined with this page's own starting
  // price rather than the sitewide default.
  images: [
    {
      url: '/og/packages.jpg',
      width: 1200,
