...
const ROUTES = [
  ...
  '/terms/',
  '/blog/',
  '/blog/bathroom-renovation-cost-sydney/',
  '/blog/bathroom-renovation-timeline-sydney/',
  '/blog/how-to-compare-bathroom-renovation-quotes/',
  '/blog/questions-to-ask-a-bathroom-renovator/',
  '/blog/bathroom-renovation-checklist-sydney/',
  '/blog/small-bathroom-renovation-without-feeling-cramped/',
  '/blog/bathroom-renovation-mistakes-to-avoid/',
  '/blog/diy-or-professional-bathroom-renovation/',
  '/blog/strata-bathroom-renovation-sydney/',
  '/blog/bathroom-renovation-hidden-costs-sydney/',
  '/blog/bathroom-renovation-essential-upgrades/',
  '/blog/bathroom-renovation-warranty-guide/',
  '/blog/fast-bathroom-renovation-what-to-expect/',
  '/blog/bathroom-trends-australia-right-now/',
  '/blog/small-bathroom-storage-solutions/',
  '/blog/bathroom-lighting-ideas/',
  '/blog/bathroom-tiling-and-finishes-guide/',
  '/services/',
